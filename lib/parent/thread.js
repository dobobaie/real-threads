...
module.exports = class Thread
{
  ...
  async close() {
    ...
    await Promise.forEach(Object.keys(this.listThreads.list), thread_key =>
  ...
  create(thread_code) {
    this.debug('[DEBUG]', `NTHREAD-CHILD: creating a new child thread`);
    ...
    return new Promise(resolve =>
      this.on(`${guuid}_client_connected`, () => resolve(childThread))
    );
  }
